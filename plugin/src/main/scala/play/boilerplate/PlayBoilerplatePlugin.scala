...
object PlayBoilerplatePlugin extends AutoPlugin {
  ...
  override val projectSettings: Seq[Def.Setting[_]] = Seq(
    ...
    Keys.generateJsonCodeGenerator := new PlayJsonGeneratorParser(),
    Keys.generateModel := true,
    Keys.generateModelCodeGenerator := new PlayModelGeneratorParser(),
    Keys.generateClient := false,
    Keys.generateClientCodeGenerator := new PlayClientGeneratorParser(),
    Keys.generateServer := false,
    Keys.generateServerCodeGenerator := new PlayServerGeneratorParser(),
    Keys.generateRoutes := false,
    Keys.generateRoutesCodeGenerator := new DynamicRoutesGenerator(),
    Keys.generateServiceCodeGenerator := new PlayServiceGeneratorParser(),
